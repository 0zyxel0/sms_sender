...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 28, 2019 at 11:40 PM
...
CREATE TABLE `bulknotification_activities` (
  `id` int(11) NOT NULL,
  `sms_to` varchar(40) NOT NULL,
  `message` varchar(250) NOT NULL,
  `sms_status` varchar(25) NOT NULL,
  `createdon` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `updatedon` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `createdby` varchar(65) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('aee33dbb-2282-11e9-8c97-ace2d3624318', 'Miller', 'Test', 'Test', 'Test', '', 'Single', 'Female', '2001-01-09', 18, '77f9afea-c316-11e8-a587-ace2d3624318', 'Admin', '2019-01-27 23:27:08'),
...
('a32d557e-2250-11e9-8952-ace2d3624318', '339dc8b3-19d2-11e9-89f2-ace2d3624318', 'ui/photo_library/FB_IMG_1533126045903.jpg', 'Admin', '2019-01-27 17:28:54', '2019-01-27 19:15:01');
...
(1, '6789689', 0, 'GTONE', '2019-01-28 23:32:45'),
(2, '2345243523', 1, 'GTONE', '2019-01-28 23:37:22'),
...
--
ALTER TABLE `gate_history`
  MODIFY `transaction_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=135;
